...
//	);
	...
	var Dropdown = React.createClass({displayName: "Dropdown",
				...
				render: function() {
					return React.createElement("div", null, React.createElement("div", {className: "dropdown-container" + (this.state.listVisible ? " show" : "")}, 
							...
							React.createElement("button", {className: 'btn btn-primary', style: { marginTop: '20px', marginLeft:'10px',height:'40px'}}, React.createElement("span", null, "Aceptar"))
							);
				},
